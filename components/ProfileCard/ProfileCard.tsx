...
const ProfileCard: FC<ProfileCardTypes> = ({
  ...
  return (
    <div className="relative px-8 py-24 hover:scale-105 hover:rotate-0 transition bg-gradient-to-b from-slate-300 to-zinc-400/80 rounded-[80px] flex flex-col items-center gap-6 shadow-lg even:rotate-1 odd:-rotate-1">
      <div className="p-3 bg-white absolute rounded-full shadow-inner top-5"></div>
